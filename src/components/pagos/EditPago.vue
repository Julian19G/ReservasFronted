                ...
                <form @submit.prevent="updatePago">
                    <div class="row mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="id" placeholder="ID del Pago" disabled v-model='pago.id'>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="id_viaje" placeholder="Id del Viaje" v-model='pago.id_cliente'>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="monto" placeholder="Valor del Pago" v-model='pago.monto'>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="metodo_pago" placeholder="Metodo de Pago" v-model='pago.metodo_pago'>
                        </div>
                    </div>
                    </div>
